        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card">
              ...
              >
                <div>
                  <h4 className="card-title mb-0">Nav Pills Tabs - Left Align</h4>
                </div>
                      ...
                      <div className="modal-content">
                        <div className="modal-header border-bottom">
                          <h5 className="modal-title" id="exampleModalLabel">
                            Nav Pills Tabs - Left Align - View Code
                          </h5>
                          <button
                            type="button"
                            className="btn-close"
                        ...
                        <div className="modal-body p-4">
                          <pre className="language-html scrollable">
                            {"                                                        "}
                            <code>
                              {"\n"}
                              {
                              ...
                              src="../assets/images/big/img2.jpg" alt=""
                              class="img-fluid"&gt; &lt;/div&gt;{"\n"}
                              {
                                "                                                                        "
                              }
                              &lt;div class="col-md-8"&gt; Raw denim you probably
                              haven't heard of them jean shorts Austin. Nesciunt tofu
                              stumptown aliqua, retro synth master cleanse. Mustache
                              ...
                              &lt;div class="col-md-4"&gt; &lt;img
                              src="../assets/images/big/img1.jpg" alt=""
                              class="img-fluid"&gt; &lt;/div&gt;{"\n"}
                              {
                                "                                                                    "
                              }
                              ...
                              &lt;div class="tab-pane p-3" id="navpill-3"
                              role="tabpanel"&gt;{"\n"}
                              {
                                "                                                                    "
                              }
                              ...
                              &lt;div class="col-md-4"&gt; &lt;img
                              src="../assets/images/big/img3.jpg" alt=""
                              class="img-fluid"&gt; &lt;/div&gt;{"\n"}
                              {
                                "                                                                        "
                              }
              ...
              <div className="card-body">
                ...
                <div>
                  ...
                  <div className="tab-content border mt-2">
                    <div className="tab-pane active p-3" id="navpill-1" role="tabpanel">
                      <div className="row">
                    ...
                    <div className="tab-pane p-3" id="navpill-2" role="tabpanel">
                      <div className="row">
                        <div className="col-md-8">
                          Raw denim you probably haven't heard of them jean shorts
                          Austin. Nesciunt tofu stumptown aliqua, retro synth master
                    ...
                    <div className="tab-pane p-3" id="navpill-3" role="tabpanel">
                      <div className="row">
                        <div className="col-md-4">
                          <img
          ...
          <div className="col-md-6">
            <div className="card">
              ...
              >
                <div>
                  <h4 className="card-title mb-0">Nav Pills Tabs - Right Align</h4>
                </div>
                <div className="ms-auto">
                  ...
                  >
                    <div className="modal-dialog">
                      <div className="modal-content">
                        <div className="modal-header border-bottom">
                          <h5 className="modal-title" id="exampleModalLabel">
                            Nav Pills Tabs - Right Align - View Code
                          </h5>
                          <button
                            type="button"
                            className="btn-close"
                        ...
                        <div className="modal-body p-4">
                          <pre className="language-html scrollable">
                            ...
                            <code>
                              ...
                              &lt;div class="tab-pane active p-3" id="navpill-11"
                              role="tabpanel"&gt;{"\n"}
                              {
                                "                                                                    "
                              }
                              ...
                              &lt;div class="tab-pane p-3" id="navpill-22"
                              role="tabpanel"&gt;{"\n"}
                              {
                                "                                                                    "
                              }
                              ...
                              &lt;div class="tab-pane p-3" id="navpill-33"
                              role="tabpanel"&gt;{"\n"}
                              {
                                "                                                                    "
                              }
              ...
              <div className="card-body">
                ...
                <div>
                  ...
                  <div className="tab-content border mt-2">
                    ...
                    <div className="tab-pane p-3" id="navpill-22" role="tabpanel">
                      <div className="row">
                        <div className="col-md-8">
                          Raw denim you probably haven't heard of them jean shorts
                          Austin. Nesciunt tofu stumptown aliqua, retro synth master
                    ...
                    <div className="tab-pane p-3" id="navpill-33" role="tabpanel">
                      <div className="row">
                        <div className="col-md-4">
                          <img
                            src="../../assets/images/big/img3.jpg"
